...
#     AUTHOR => [q[Juan JosÃ© 'Peco' San MartÃ­n <peco@cpan.org>]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     LICENSE => q[perl]
...
DISTVNAME = Email-Send-SMTP-Gmail-1.22
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version: '\''1.22'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "version" : "1.22",' >> META_new.json
