...
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], MIME::Base64=>q[0], Net::SMTPS=>q[0], Net::SMTP_auth=>q[0], File::Spec=>q[0], LWP::MediaTypes=>q[0] }
...
DISTVNAME = Email-Send-SMTP-Gmail-0.58
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '   "version" : "0.58"' >> META_new.json
	$(NOECHO) $(ECHO) '}' >> META_new.json
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0.58">' > $(DISTNAME).ppd
